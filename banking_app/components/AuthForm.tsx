                  ...
                  {type === 'sign-up' && (
                   ...
                   <CustomInput control={form.control} name='firstname' label="First Name" 
                    ...
                    placeholder='Example: Karnataka' />
                       <CustomInput control={form.control} name='pincode' label="Pincode" 
                    placeholder='Example: 560064' />
                    </div>

                    <div className="flex gap-4">
                       <CustomInput control={form.control} name='dob' label="Date of Birth" 
                    placeholder='DD-MM-YYYY' />
                      <CustomInput control={form.control} name='aadhaar' label="Aadhaar Number" 
                    placeholder='Example: 8972-7283-8264' />
                    </div>
                    </>
                  )}
